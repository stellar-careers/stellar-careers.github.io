...
f'            <li class="sd appear header-nav-item header-has-dropdown"><a href="{P}industry-knowledge" class="text link sd appear header-nav-link">Industry knowledge</a>\n'
'              <ul class="header-dropdown">\n'
f'                <li><a href="{P}industry-knowledge#strategy" class="header-dropdown-link">戦略コンサルファーム</a></li>\n'
f'                <li><a href="{P}industry-knowledge#consulting" class="header-dropdown-link">総合/ITコンサルファーム</a></li>\n'
f'                <li><a href="{P}industry-knowledge#research" class="header-dropdown-link">総研</a></li>\n'
f'                <li><a href="{P}industry-knowledge#boutique" class="header-dropdown-link">ブティックファーム</a></li>\n'
f'                <li><a href="{P}industry-knowledge#ai" class="header-dropdown-link">AIファーム</a></li>\n'
f'                <li><a href="{P}industry-knowledge#startup" class="header-dropdown-link">スタートアップ</a></li>\n'
f'                <li><a href="{P}industry-knowledge#firm-articles" class="header-dropdown-link">ファーム研究記事</a></li>\n'
'              </ul>\n'
'            </li>\n'
