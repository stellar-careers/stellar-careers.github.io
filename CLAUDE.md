...
Header-only breakpoints (see the header overflow fix at the end of style.css):

    @media (max-width: 1240px)                          Nav collapses into the hamburger (CTAs stay in the bar)
    @media (min-width: 1241px) and (max-width: 1359px)  Nav shown with tightened spacing
